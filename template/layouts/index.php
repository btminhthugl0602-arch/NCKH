...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo _HOST_URL_TEMPLATES; ?>/assets/img/apple-icon.png">
    <link rel="icon" type="image/png" href="<?php echo _HOST_URL_TEMPLATES; ?>/assets/img/favicon.png">
    <title>
    ...
    <!-- Nucleo Icons -->
    <link href="<?php echo _HOST_URL_TEMPLATES; ?>/assets/css/nucleo-icons.css" rel="stylesheet" />
    <link href="<?php echo _HOST_URL_TEMPLATES; ?>/assets/css/nucleo-svg.css" rel="stylesheet" />
    <!-- Font Awesome Icons -->
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="<?php echo _HOST_URL_TEMPLATES; ?>/assets/css/material-dashboard.css?v=3.2.0"
        rel="stylesheet" />
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <script src="<?php echo _HOST_URL_TEMPLATES; ?>/assets/js/plugins/chartjs.min.js"></script>
    <script>
    ...
    <script src="<?php echo _HOST_URL_TEMPLATES; ?>/assets/js/material-dashboard.min.js?v=3.2.0"></script>
</body>
